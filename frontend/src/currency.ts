const SUPPORTED_REGIONS = {
  ...
  worldwide: { currency: 'USD', locale: 'en-US', distanceUnit: 'km',    calendarStart: 1 },
} as const;
...
const distanceUnitOverride = window.__APP_DISTANCE_UNIT__;
const effectiveDistanceUnit = distanceUnitOverride ?? regionSettings.distanceUnit;
...
export const useMiles = effectiveDistanceUnit === 'miles';
export const supportsCarInfoLookup = activeRegion === 'sweden' || activeRegion === 'norway';
export const distanceLabel = effectiveDistanceUnit;
